/*
  Virtual Functions work through the virutal funciton table (vtable/vtbl);
  The vtable is a table of function pointers that are used to implement dynamic
  binding.
  * The space overhead is 1 pointer in each virtual function in the class
  * Plus 1 pointer for each class with virtual functions
*/
